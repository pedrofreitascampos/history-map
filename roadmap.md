...
**Status as of 2026-06-04:** **10 of 10 original P0s shipped + 8 of S2 P1s closed across two batches.** Audit P0 close-out complete. S2 P1 hardening batch 2026-06-04 morning (+16 jest, 986+3skip green): narrate+discover rate limits ✅, CSP photon.komoot.io ✅, render.yaml ANTHROPIC_API_KEY ✅, exact-pin @anthropic-ai/sdk ✅, notes server-side sanitisation ✅. S2 perf cold-load batch 2026-06-04 afternoon (+14 jest, **1000+3skip green**, 8/8 e2e): Cache-Control+ETag on /api/locations ✅, initMap-before-await ✅, defer Chart.js/TopoJSON/JSZip/exifr ✅. Next: surgical rebuildIndexes, DNS-rebinding SSRF, more.onclick migration.
